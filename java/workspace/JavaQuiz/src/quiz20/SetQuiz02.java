...
//		set2.add(41);
//		set2.add(13);
		Integer[] set2 = { 5, 23, 35, 7, 41, 13 };
		List<Integer> list = Arrays.asList(set2);
		...
		System.out.println("당신이 시도한 횟수: " + cnt);
		System.out.println("당신이 날린 돈: " + money);
	}
}
